...
export default function Login(props) {
    ...
    return `
        <div class="flex items-center text-center justify-center bg-cover content-height"
            ...
            <div class="bg-[#FFFFFF] opacity-95 w-3/4 lg:w-1/2 border-2 border-slate-300 shadow-xl rounded-md">
                <form id="login-form" class="flex flex-col items-center text-center justify-center px-[15px] w-full mt-[100px]">
                    ...
                    <input id="email" class=" bg-[#FFFFFF] w-3/4 mx-1 my-3 p-1 border-b-2 border-callToAction outline-0 placeholder-callToAction" name="email" type="email" placeholder="Email"/>

                    <label for="password" class="px-[10px] my-auto"></label>

                    <input id="password" class="bg-[#FFFFFF] w-3/4 mx-1 my-3 p-1 border-b-2 border-callToAction outline-0 placeholder-callToAction" name="password" type="password" placeholder="Password"/>

                    <button id="login-btn" class="w-1/4 p-2 mx-2 my-2 rounded-md shadow-xl text-[#002254] bg-callToAction">Login</button>
                </form>
                <p class="register-link flex-wrap my-[50px]">Don't have an account?
                    <button class="p-2 mx-1 my-2 rounded-md shadow-xl text-[#002254] bg-callToAction" id="goToRegister">Register Here</button>
                </p>
            </div>
        </div>`;
}
